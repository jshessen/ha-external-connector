...
Modern Python implementation of the AWS resource management functionality
originally implemented in bash aws_manager.sh.
"""
...
class AWSIAMManager(AWSBaseManager):
    ...
    def create_or_update(self, _spec: IAMResourceSpec) -> AWSResourceResponse:
        ...
        return AWSResourceResponse(status="not_implemented", errors=["Not implemented"])
    def read(self, _resource_id: str, _resource_type: str = "role") -> AWSResourceResponse:
