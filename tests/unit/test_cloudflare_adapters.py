...
def create_test_cloudflare_config():
...
class TestCloudFlareManager:
    ...
    @patch("ha_connector.adapters.cloudflare_manager.CloudFlareManager."
           "_create_http_client")
    def test_init_with_valid_credentials(self, mock_create_client, mock_validate):
    ...
    @patch("ha_connector.adapters.cloudflare_manager.CloudFlareManager."
           "_create_http_client")
    def test_load_config_from_env(self, mock_create_client, mock_validate):
    ...
    @patch("ha_connector.adapters.cloudflare_manager.CloudFlareManager."
           "_create_http_client")
    def test_managers_initialized(self, mock_create_client, mock_validate):
...
class TestCloudFlareResourceTypes:
    ...
    def test_resource_type_values(self):
        ...
        assert CloudFlareResourceType.ZONE == "zone"
...
class TestCloudFlareConfig:
    ...
    def test_config_with_api_key_and_email(self):
...
class TestDNSRecordSpec:
    ...
    def test_minimal_dns_record(self):
...
class TestCredentialValidation:
    ...
    def test_valid_api_key_email_pair(self):
    ...
    def test_invalid_partial_credentials(self):
...
class TestErrorHandling:
    ...
    @patch("ha_connector.adapters.cloudflare_manager.CloudFlareManager."
           "_create_http_client")
    def test_manager_creation_success(self, mock_create_client, mock_validate):
